      ...
      <section>
        <v-parallax :src="require('../assets/squad.jpg')" height="600">
          <v-layout column align-center justify-center class="white--text">
            <h1 class="white--text mb-2 display-4 text-xs-center">Meet the Squad</h1>
          </v-layout>
        </v-parallax>
      </section>
...
export default {
  ...
  data() {
    return {
      ...
      We believe that fundamental concepts which are essentially the key ingridients for a successful career are often over looked. This is 
